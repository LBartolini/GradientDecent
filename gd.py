...
def gradientDescent(funct, data_to_display=np.arange(-5, 5, 0.001), precision_points=3, lr=1e-2, display=False, steps_to_display=300, logspace_limits=(-1, 0), explorer_reduction=10, precision_tangent=1e-4, treshold_to_stop=1e3):
	minimum = None
